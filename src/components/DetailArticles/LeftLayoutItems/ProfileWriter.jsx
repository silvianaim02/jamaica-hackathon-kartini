...
const ProfileWriter = () => {
  return (
    <div className="w-full items-start border border-gray-200 justify-start flex flex-col px-12 pb-5">
      ...
      <div className="flex items-center pt-5">
        <h1 className="font-medium text-accent-2 text-base pr-6">Anne</h1>
      ...
      <h1 className='text-accent-2 text-lg mt-1'>73 Followers</h1>
