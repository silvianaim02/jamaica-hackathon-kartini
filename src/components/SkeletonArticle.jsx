const SkeletonArticle = () => {
  return (
    <div
      role="status"
      className="animate-pulse w-full mb-4 flex flex-col lg:flex-row lg:items-center gap-4 p-6  rounded-lg"
    >
      <div className="flex items-center justify-center w-full h-48 bg-[#E3EEFF] rounded sm:w-96 ">
        <svg
          className="w-7 h-7 rounded-full text-gray-200"
